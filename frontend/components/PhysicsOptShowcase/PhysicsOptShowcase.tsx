    ...
    <div className="w-full max-w-5xl mx-auto">
      <div
        className={`relative overflow-hidden rounded-2xl border transition-all duration-700 ease-in-out ${
          isExpanded
            ? "border-amber-500/30 bg-card shadow-2xl shadow-amber-900/20"
            : "border-border bg-card/80 hover:border-amber-500/30"
        } backdrop-blur-xl`}
      >
        {/* Background Glow */}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-5">
              <div className="relative">
                ...
                <div className="relative p-3 rounded-xl bg-card border border-border shadow-lg group-hover:border-amber-500/50 transition-colors">
                  <Zap className="w-6 h-6 text-amber-500" />
                </div>
              </div>
              <div className="text-left">
                <div className="flex items-center gap-2 text-[10px] font-mono text-amber-500 mb-1 tracking-widest uppercase">
                ...
                <h3 className="text-xl font-bold text-foreground group-hover:text-amber-500 transition-colors tracking-tight">
                  {locale === "cs"
            ...
            <div className="flex items-center gap-4 text-sm font-medium text-muted-foreground group-hover:text-foreground transition-colors relative">
              {!isExpanded && (
                <div className="hidden md:block absolute -left-12 top-1/2 -translate-y-1/2">
                  <ChevronRight className="w-5 h-5 text-amber-500 animate-[slide-right_2s_ease-in-out_infinite]" />
                </div>
              )}
              <span
              ...
              <div
                className={`p-2 rounded-full bg-muted border border-border group-hover:bg-amber-500/10 group-hover:border-amber-500/30 transition-all duration-300 ${
                  !isExpanded &&
                      ...
                      <div
                        className={`group relative p-5 rounded-2xl text-sm leading-relaxed border backdrop-blur-sm transition-all duration-300 hover:shadow-lg inline-block text-left ${
                          msg.role === "blue"
                            ...
                            : msg.role === "purple"
                            ? "bg-purple-500/10 border-purple-400/30 hover:border-purple-400/50 text-purple-100 shadow-[0_0_15px_rgba(168,85,247,0.15)]"
                            : msg.role === "orange"
                            ? "bg-orange-500/10 border-orange-400/30 hover:border-orange-400/50 text-orange-100 shadow-[0_0_15px_rgba(249,115,22,0.15)]"
                            : msg.role === "red"
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 bg-card/90 border-t border-border backdrop-blur-xl flex items-center justify-between z-20">
              ...
              {currentPhase < phases.length - 1 ? (
                <Button
                  ...
                  disabled={isResuming}
                  className={`bg-amber-500 hover:bg-amber-600 text-black shadow-[0_0_15px_rgba(245,158,11,0.4)] gap-2 px-4 transition-all duration-300 ${
