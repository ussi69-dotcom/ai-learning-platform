...
import { PhysicsOptPhase } from './physicsOptPhases';

interface UsePhysicsOptAnimationProps {
  phases: PhysicsOptPhase[];
  isExpanded: boolean;
}

interface UsePhysicsOptAnimationReturn {
  currentPhase: number;
...
export function usePhysicsOptAnimation({ phases, isExpanded }: UsePhysicsOptAnimationProps): UsePhysicsOptAnimationReturn {
