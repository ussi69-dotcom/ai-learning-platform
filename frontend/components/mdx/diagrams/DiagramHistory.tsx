      ...
      <div className="my-8 flex justify-center -mx-6 w-[calc(100%+3rem)] md:mx-0 md:w-full">
        <div className="relative p-4 md:p-6 rounded-none md:rounded-2xl bg-white/5 backdrop-blur-xl border-y md:border border-white/10 shadow-lg w-full max-w-none md:max-w-3xl">
          <svg
            ...
            role="img"
            aria-label="Traditional Programming vs Machine Learning"
          >
            <defs>
              <marker
                id="arrowhead-tvm"
            ...
            <g transform="translate(50, 40)">
              <text
                ...
                y="0"
                textAnchor="middle"
                className="text-lg font-bold fill-blue-600 dark:fill-blue-400 uppercase"
              >
                {isCs ? "Tradiční" : "Traditional"}
              </text>
              ...
              <rect
                ...
                stroke="#334155"
              />
              <text x="120" y="155" textAnchor="middle" className="text-2xl">
                💻
              </text>

              {/* Output */}
              <path
                d="M 120 180 L 120 210"
                stroke="#94a3b8"
                strokeWidth="2"
                markerEnd="url(#arrowhead-tvm)"
              />
            ...
            <g transform="translate(400, 40)">
              <text
                ...
                y="0"
                textAnchor="middle"
                className="text-lg font-bold fill-purple-600 dark:fill-purple-400 uppercase"
              >
              ...
              <text
                ...
                y="235"
                textAnchor="middle"
                className="text-sm font-bold fill-amber-700 dark:fill-amber-300"
              >
                {isCs ? "Pravidla" : "Rules"}
              </text>
            </g>
      ...
      <div className="my-8 flex justify-center -mx-6 w-[calc(100%+3rem)] md:mx-0 md:w-full">
        <div className="relative p-4 md:p-6 rounded-none md:rounded-2xl bg-white/5 backdrop-blur-xl border-y md:border border-white/10 shadow-lg w-full max-w-none md:max-w-6xl">
          <svg
            ...
            className="w-full h-auto"
            role="img"
            aria-label="The Two Waves of AI: Discriminative vs Generative"
          >
            <defs>
              <marker
            ...
            <g transform="translate(50, 40)">
              <text
                x="0"
                y="0"
                className="text-base font-bold fill-slate-600 dark:fill-slate-400 uppercase tracking-widest"
              >
                {isCs
                  ? "Vlna 1: Diskriminativní AI"
                  : "Wave 1: Discriminative AI"}
              </text>
              ...
              <g transform="translate(0, 30)">
                <rect
                  ...
                  stroke="#3b82f6"
                />
                <text x="30" y="35" textAnchor="middle" className="text-4xl">
                  🐱
                </text>
                <text
                  x="30"
              ...
              <g transform="translate(140, 30)">
                <polygon
                  ...
                  stroke="#a855f7"
                />
                <text x="30" y="35" textAnchor="middle" className="text-3xl">
                  ⚖️
                </text>
                <text
                  x="30"
                  y="75"
                  textAnchor="middle"
                  className="text-sm fill-purple-700 dark:fill-purple-300"
                >
                  {isCs ? "Soudce" : "The Judge"}
                </text>
              </g>
            ...
            <g transform="translate(50, 180)">
              <text
                ...
                className="text-base font-bold fill-slate-600 dark:fill-slate-400 uppercase tracking-widest"
              >
                {isCs ? "Vlna 2: Generativní AI" : "Wave 2: Generative AI"}
              </text>
              ...
              <g transform="translate(0, 30)">
                ...
                <text
                  ...
                  y="25"
                  textAnchor="middle"
                  className="text-xs font-bold fill-amber-700 dark:fill-amber-200"
                >
                  {isCs
                    ? '"Namaluj kyberpunk kočku"'
                    : '"Paint a cyberpunk cat"'}
                </text>
                <text
                  x="50"
                  y="75"
              ...
              <g transform="translate(170, 30)">
                ...
                <text
                  ...
                  y="75"
                  textAnchor="middle"
                  className="text-sm fill-pink-700 dark:fill-pink-300"
                >
                  {isCs ? "Tvůrce" : "The Creator"}
                </text>
              </g>
              ...
              <g transform="translate(300, 20)">
                <rect
                  ...
                  strokeWidth="2"
                />
                <text x="40" y="45" textAnchor="middle" className="text-4xl">
                  🐱🤖
                </text>
                <defs>
                  <linearGradient
      ...
      <div className="my-8 flex justify-center -mx-6 w-[calc(100%+3rem)] md:mx-0 md:w-full">
        <div className="relative p-4 md:p-6 rounded-none md:rounded-2xl bg-white/5 backdrop-blur-xl border-y md:border border-white/10 shadow-lg w-full max-w-none md:max-w-6xl overflow-x-auto">
          <svg
            ...
            role="img"
            aria-label="History of AI: 1950s to Now"
          >
            {/* Timeline Line */}
            <line
              x1="50"
            ...
            <g transform="translate(50, 60)">
              ...
              >
                {isCs ? "Turingův test" : "Turing Test"}
              </text>
            </g>
            ...
            <g transform="translate(200, 60)">
              ...
              <text
                ...
                className="text-sm font-bold fill-slate-600 dark:fill-slate-400"
              >
                {isCs ? "Deep Blue (Šachy)" : "Deep Blue (Chess)"}
              </text>
            </g>
            ...
            <g transform="translate(350, 60)">
              ...
              <text
                ...
                className="text-sm font-bold fill-slate-600 dark:fill-slate-400"
              >
                {isCs ? "AlexNet (Vidění)" : "AlexNet (Vision)"}
              </text>
            </g>
            ...
            <g transform="translate(500, 60)">
              ...
              <text
                ...
                y="20"
                textAnchor="middle"
                className="text-lg font-bold fill-amber-700 dark:fill-amber-300"
              >
                2017
              </text>
              <text
            ...
            <g transform="translate(650, 60)">
              ...
              <text
                ...
                y="130"
                textAnchor="middle"
                className="text-xs font-bold fill-slate-800 dark:fill-white"
              >
                ChatGPT
              </text>
            </g>
