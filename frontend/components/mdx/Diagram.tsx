...
export default function Diagram({ type }: DiagramProps) {
  ...
  if (['local-llm-architecture', 'mcp-architecture', 'model-benchmark-chart', 'vram-stack', 'latency-comparison', 'antigravity-workflow', 'ide-comparison-radar', 'ollama-ecosystem', 'claude-approval-loop', 'context-bucket', 'claude-md-anatomy', 'paradigm-shift-pyramid', 'mcp-capability-types', 'mcp-ecosystem-map', 'context-hierarchy', 'ide-selection-decision-tree', 'ai-security-layers', 'antigravity-dual-interface', 'artifacts-workflow', 'planning-vs-fast-mode', 'security-attack-chain'].includes(type)) {
