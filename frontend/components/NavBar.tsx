      ...
      <div className="container mx-auto px-3 sm:px-4">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 py-2 sm:py-0 sm:h-14">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Link
              href="/"
              className="text-lg sm:text-xl font-black text-gradient hover:opacity-80 transition-opacity whitespace-nowrap"
            >
              AI Edutainment
            </Link>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {user ? (
              <div className="flex items-center gap-1 sm:gap-2">
                ...
                <Link
                  href="/profile"
                  className="flex items-center gap-2 px-2 sm:px-3 py-1.5 rounded-xl border border-transparent hover:border-primary/50 hover:bg-primary/5 transition-all duration-300"
                >
                  {/* Avatar */}
                  <XPAvatarBadge
              ...
              <div className="flex items-center gap-1.5 sm:gap-2">
                <Link href="/login">
                  <Button
                    variant="ghost"
                    size="sm"
                    className="text-xs sm:text-sm px-2 sm:px-3 h-8 font-semibold text-foreground hover:text-primary"
                  >
                    {t("login") || "Sign In"}
                  </Button>
                </Link>
                <Link href="/register">
                  <Button
                    size="sm"
                    className="text-xs sm:text-sm px-2 sm:px-4 h-8 font-semibold btn-glow"
                  >
                    {t("register") || "Sign Up"}
                  </Button>
                </Link>
