[  ] Procesy, dokumentace, instrukce, prubezny updating, long a short shared memory a dalsi, vse uz hraje? Potrebuju abys jel maximalne efektivne, drzel se postupu a ja mel prehled. Jestli nepouzivas rules.md, ktere byly pro Gemini.cli a Antigravity, vytahni z nich, co se hodi pro nasi spolupraci a dopln si asi do claude.md?
