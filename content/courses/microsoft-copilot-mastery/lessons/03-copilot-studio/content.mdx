...
- **Model choice (preview in some tenants):** Some tenants can choose between models (e.g., OpenAI GPT‑4o and Anthropic Claude 3.5). Higher quality often means higher cost/latency—map it to the use case.
- **Tool integration:** Connectors/actions today; standardized tool protocols (e.g., MCP) are roadmap/preview in some tenants.
