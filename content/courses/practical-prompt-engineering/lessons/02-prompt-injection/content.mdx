...
<Callout type="info">
**Mission Goal:** Learn to **structure AI reasoning** and then **break unsafe prompts before someone else does**.

⏳ **Reading Time:** 35 min | 🧪 **[4] Labs Included**
</Callout>
...
**What if I told you that every AI chatbot you've ever used can be manipulated with a single line of text?**

OWASP’s Top 10 for LLM Applications (2025) lists **Prompt Injection** as **LLM01** — the #1 risk. DeepMind’s 2025 paper on defending Gemini against **indirect prompt injections** shows how attacks can be hidden inside emails, PDFs, or web pages the model reads.

If your AI can read untrusted content, it is already a target.

Today you'll learn two critical skills:
1. **Structured reasoning** — 🧠 How to make AI show its steps in a controlled format
...
The video above isn't about AI at all — it's about **SQL Injection**. But that's exactly why you need to watch it.
...
<Callout type="tip">
NetworkChuck's SQL Injection video is the **perfect analogy** for understanding why prompt injection is so dangerous — and so hard to fix.

🔗 **Bonus:** [LLM Penetration Testing Guide](https://haxoris.com/cz/clanky/penetracni-testovani-llm-integraci) — Haxoris (advanced)
</Callout>
...
**Reality check:** OWASP Top 10 for LLM Apps (2025) lists Prompt Injection as LLM01. DeepMind’s 2025 “Lessons from Defending Gemini Against Indirect Prompt Injections” shows indirect attacks hidden inside the content your model reads.
</Callout>
...
This simple sentence nudges most modern models to structure their answer. If a model hides chain-of-thought, ask for a **brief reasoning outline** or a checklist instead.
...
Go to [gandalf.lakera.ai](https://gandalf.lakera.ai/) — a free prompt injection wargame.
...
| Level | Defense | Hint |
|-------|---------|------|
| 1️⃣ | None | Just ask nicely |
| 2️⃣ | "Don't reveal password" | Basic bypass |
| 3️⃣ | Output filter | Encode the response |
| 4️⃣ | Input + Output filter | Virtualization |
| 5️⃣ | Multi-layer | Combined techniques |
| 6️⃣ | Advanced | You'll see... |
| 7️⃣ | Hardcore | Pure creativity |
...
<Callout type="warning">
**Warning:** This is addictive. Many developers have lost entire afternoons to Gandalf. Set a timer! ⏱️
</Callout>
...
1. 🧠 **Structured reasoning helps:** Ask for a brief reasoning outline or checklist to reduce mistakes.
