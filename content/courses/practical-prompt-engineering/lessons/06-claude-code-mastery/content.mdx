...
<VideoSwitcher alternatives={[{"id":"H5M4LhMwFpw","title":"These New Claude Code Features are HUGE (2.0.67)"},{"id":"9PnUuYN3klA","title":"Claude Code Tutorial - Intro & Setup"},{"id":"D0Rgtgtzlts","title":"CZ SWE AI Program - Frontend Debugging (CZ)"}]} />
