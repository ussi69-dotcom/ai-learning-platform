...
Now let's break your brain. We will run **two agents at once**—one researching, one coding.
...
### 📋 Prerequisites
- Completed Lab 1
- A basic React/Next.js project (or ask Antigravity to create one)
...
How does this stack up against the other AI coding titans?
...
| **Image Generation** | Nano Banana (built-in) | None | None |
...
| **Nano Banana** | Built-in image generation for mockups |
