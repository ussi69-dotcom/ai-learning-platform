...
![Agent Manager in action - multiple workspaces, progress tracking, and Claude Opus 4.5](images/agent-manager.png)
...
![Implementation Plan artifact with inline commenting and Review button](images/artifacts-panel.png)
